ScriptName Venworks:EncountersOverhaul:Quests:Clutter:Small:VEOH_Clutter_Spacers_Small_01 extends Venworks:EncountersOverhaul:Core:Base:BaseQuest
{Handler script for the Radiant Engine Quest - VEOH_Clutter_Spacers_Small_01}
...
Event OnQuestInit()
  LogUserInformational(moduleName="Quests:Clutter:Small:VEOH_Clutter_Spacers_Small_01", functionName="OnQuestInit", logMessage="Quest Init Fired")
EndEvent

; Event received when the quest has been started
Event OnQuestStarted()
  LogUserInformational(moduleName="Quests:Clutter:Small:VEOH_Clutter_Spacers_Small_01", functionName="OnQuestStarted", logMessage="Quest OnQuestStarted Fired")
EndEvent
...
Event OnQuestShutdown()
  LogUserInformational(moduleName="Quests:Clutter:Small:VEOH_Clutter_Spacers_Small_01", functionName="OnQuestShutdown", logMessage="Quest Shutdown Fired")
EndEvent
...
Function HandleEncounterStarted()
  LogUserInformational(moduleName="Quests:Clutter:Small:VEOH_Clutter_Spacers_Small_01", functionName="HandleEncounterStarted", logMessage="Encounter Started: Nothing really to do")
  SetStage(25)
EndFunction

;; Encounter Scene Setup
Function HandleEncounterSceneSetup()
  LogUserInformational(moduleName="Quests:Clutter:Small:VEOH_Clutter_Spacers_Small_01", functionName="HandleEncounterSceneSetup", logMessage="Encounter Scene Setup: Starting")
...
Function HandleEncounterSceneSetupComplete()
  LogUserInformational(moduleName="Quests:Clutter:Small:VEOH_Clutter_Spacers_Small_01", functionName="HandleEncounterSceneSetupComplete", logMessage="Encounter Scene Setup: Completed")
  SetStage(50)
EndFunction

;; Encounter NPC Setup
Function HandleEncounterActorSetup()
  LogUserInformational(moduleName="Quests:Clutter:Small:VEOH_Clutter_Spacers_Small_01", functionName="HandleEncounterActorSetup", logMessage="Encounter Actor Setup: Starting")
...
Function HandleEncounterActorSetupComplete()
  LogUserInformational(moduleName="Quests:Clutter:Small:VEOH_Clutter_Spacers_Small_01", functionName="HandleEncounterActorSetupComplete", logMessage="Encounter Actor Setup: Completed")
...
Function HandleEncounterInProgressPlayerInRange()
  LogUserInformational(moduleName="Quests:Clutter:Small:VEOH_Clutter_Spacers_Small_01", functionName="HandleEncounterInProgressPlayerInRange", logMessage="Encounter In Progress: Player Is In Range, Displaying Objectives")
...
Function HandleEncounterInProgressPlayerKilledGroup01()
  LogUserInformational(moduleName="Quests:Clutter:Small:VEOH_Clutter_Spacers_Small_01", functionName="HandleEncounterInProgressPlayerKilledGroup01", logMessage="Encounter In Progress: Player has killed Group 01")
...
Function HandleEncounterInProgressPlayerKilledBoss()
  LogUserInformational(moduleName="Quests:Clutter:Small:VEOH_Clutter_Spacers_Small_01", functionName="HandleEncounterInProgressPlayerKilledBoss", logMessage="Encounter In Progress: Player has killed the boss")
...
Function HandleEncounterInProgressPlayerLootedBossChest()
  LogUserInformational(moduleName="Quests:Clutter:Small:VEOH_Clutter_Spacers_Small_01", functionName="HandleEncounterInProgressPlayerLootedBossChest", logMessage="Encounter In Progress: Player has looted the boss' chest")
  SetObjectiveCompleted(ObjectiveLootChest)
  CheckCompleteAndSetCorrectStage()
EndFunction

Function HandleEncounterComplete()
  LogUserInformational(moduleName="Quests:Clutter:Small:VEOH_Clutter_Spacers_Small_01", functionName="HandleEncounterComplete", logMessage="Encounter Complete: FYI")
...
Function HandleEncounterShutdown()
  LogUserInformational(moduleName="Quests:Clutter:Small:VEOH_Clutter_Spacers_Small_01", functionName="HandleEncounterShutdown", logMessage="Encounter Shutdown: FYI")
EndFunction