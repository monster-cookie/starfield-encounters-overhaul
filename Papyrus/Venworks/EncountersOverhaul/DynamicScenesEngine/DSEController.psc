ScriptName Venworks:EncountersOverhaul:DynamicScenesEngine:DSEController Extends Venworks:EncountersOverhaul:Base:BaseQuest
{ My version of the radiant engine quest controller. This needs added to all Dynamic Scenes Engine Managed Quests.}
